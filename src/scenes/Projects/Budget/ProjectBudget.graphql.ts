...
export type ProjectBudgetQuery = { readonly project: (
    ...
    & { readonly name: (
      ...
      & { readonly items: ReadonlyArray<{ readonly __typename?: 'InternshipEngagement' } | (
        ...
        & { readonly language: (
          ...
          { readonly __typename?: 'SecuredEngagementStatus' }
          & Pick<Types.SecuredEngagementStatus, 'value'>
        ), readonly changeset?: Types.Maybe<(
          { readonly __typename?: 'ProjectChangeRequest' }
          & Pick<Types.ProjectChangeRequest, 'id'>
        )> }
      ...
      & { readonly value?: Types.Maybe<(
        ...
        & Pick<Types.Budget, 'status' | 'sensitivity' | 'createdAt' | 'total' | 'id'>
        & { readonly records: ReadonlyArray<(
          ...
          & { readonly type: (
            ...
            { readonly __typename?: 'SecuredStringNullable' }
            & Pick<Types.SecuredStringNullable, 'canRead' | 'canEdit' | 'value'>
          ), readonly partnerAccountName: (
            { readonly __typename?: 'SecuredStringNullable' }
            & Pick<Types.SecuredStringNullable, 'canRead' | 'canEdit' | 'value'>
          ), readonly partnerAccountNumber: (
            { readonly __typename?: 'SecuredStringNullable' }
            & Pick<Types.SecuredStringNullable, 'canRead' | 'canEdit' | 'value'>
          ), readonly costType: (
            { readonly __typename?: 'SecuredString' }
