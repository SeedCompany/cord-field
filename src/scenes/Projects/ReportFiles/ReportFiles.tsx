...
import { FileNodeInfo_Directory_Fragment as Directory } from '../../../components/files/files.generated';
...
import { FileOrDirectory } from '../Files/util';
import { ReportFileRow } from './ReportFileRow';
import { ProjectReportDirectoryDocument } from './ReportFiles.generated';
import { useProjectReport } from './useProjectReport';
import { useUploadReportFiles } from './useUploadReportFiles';
...
const ReportFilesListWrapped: FC = () => {
  ...
  return reportLoading ? null : (
    <div className={classes.dropzone} {...getRootProps()}>
      <Helmet
        title={`Files - ${project ? project.name.value ?? 'A Project' : '...'}`}
      />
...
export const ReportFilesList: FC = () => (
  <FileActionsContextProvider>
    <ReportFilesListWrapped />
  </FileActionsContextProvider>
);
